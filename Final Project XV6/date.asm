...
main(int argc, char *argv[])
{
  11:	83 ec 30             	sub    $0x30,%esp
    ...
    if(date(&r)){
  14:	50                   	push   %eax
  15:	e8 38 03 00 00       	call   352 <date>
  ...
  2a:	e8 d1 03 00 00       	call   400 <printf>
        exit();
  2f:	e8 7e 02 00 00       	call   2b2 <exit>
    }

    printf(1,"%d:%d:%d %d/%d/%d\n",(r.hour+7)%24,r.minute,r.second,r.day,r.month,r.year);
  34:	8b 45 e8             	mov    -0x18(%ebp),%eax
  37:	b9 18 00 00 00       	mov    $0x18,%ecx
  ...
  4a:	83 c0 07             	add    $0x7,%eax
  4d:	ff 75 e4             	pushl  -0x1c(%ebp)
  50:	f7 f1                	div    %ecx
  52:	52                   	push   %edx
  53:	68 2d 07 00 00       	push   $0x72d
  58:	6a 01                	push   $0x1
  5a:	e8 a1 03 00 00       	call   400 <printf>
    exit();
